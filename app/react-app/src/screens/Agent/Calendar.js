...
function Calendar() {
  ...
  const [appointmentModalColor, setAppointmentModalColor] = useState(null)
  const [appointmentModalColorInput, setAppointmentModalColorInput] = useState(null)
  ...
  const handleOk = () => {
    ...
    slots = slots.map( (e,i) => {
      ...
      return {
        ...
        extendedProps: {
            visitType: appointmentModalVisitType
        }
      }
    })
    ...
    setTimeout(() => {
      ...
      setAppointmentModalColorInput(null);
